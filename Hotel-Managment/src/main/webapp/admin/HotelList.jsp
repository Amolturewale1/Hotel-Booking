...
<body>
    ...
    <%if(update.equals("added")){ %>
     <center><h5 style="color: white;">Hotel Added Successfully!!</h5></center>	
    <%}else if(update.equals("update")){%>
    	<centre><h2 style="color: white;"> Hotel Updated Successfully !!</h2> </centre>
   	<% 	}
    }
   	AdminDao adminDao=new AdminDaoImpl();
   	List<Hotel> hotels=adminDao.getAllHotelsDetails();
            ...
            <table class="table ">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>
                         <a href="/Hotel-Managment/admin/EditHotel.jsp?hotelId=<%= hotel.getId() %>" id="btn" class="button btn btn-outline-dark">Update</a>
                         &nbsp; 
                         <a href="/Hotel-Managment/DeleteHotel?hotelId=<%=hotel.getId()%>" id="btn" class="button btn btn-outline-dark">Delete</a> 
                    </td>
                  </tr>
                </tbody>
                <%} %>
