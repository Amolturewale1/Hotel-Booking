        ...
        <nav class="navbar navbar-expand-lg navbar-light navbar-expand-md">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
              <ul class="navbar-nav">
                ...
                <li class="nav-item">
                  <a class="nav-link " href="http://localhost:8080/Hotel-Managment/admin/SignUp.jsp">SignUp</a>
                </li>
                <li class="nav-item">
                  <a class="nav-link " href="http://localhost:8080/Hotel-Managment/admin/Login.jsp">Login</a>
                </li>
              </ul>
            </div>
                  ...
                  <form action="../AddAdmin"  method="post">
                      ...
                      <div class="row mb-3">
                          ...
                          <div class="col">
                            ...
                            <input type="text" class="form-control" placeholder="Gender" name=""  required >
                        </div>	
                      </div>
                      <div class="row mb-3">
                          <div class="col">
                      ...
                      <div class="row mb-3">
                        <div class="col">
                            ...
                            <input type="text" class="form-control"  placeholder="Mobile Number" name="contact" required >
                        </div>
                           <div class="col">
                      ...
                      <button href="#" id="btn" class="button btn btn-outline-dark">Create Account</button>
                  </form>
              </div>        
            </div>
          </div>
