              ...
              <form action="../AddHotel"  method="post">
                  <div class="row mb-3">
                      <div class="col">
                          ...
                          <input type="text" class="form-control"  placeholder="Hotel Name" required  name="hotelName">
                      </div>
                      <div class="col">
                          <label for="contact" class="form-label">Contact Number :</label>
                          <input type="number" class="form-control" placeholder="Contact Number "  required name="contact">
                      </div>
                  </div>
                  <div class="row mb-3">
                      <div class="col">
                      ...
                      <div class="col">
                        ...
                        <input type="text" class="form-control" placeholder="Enter City"  required  name="city">
                    </div>	
                  </div>
                  <div class="row mb-3">
                      <div class="col">
                      ...
                      <div class="col">
                          ...
                          <input type="text" class="form-control"  placeholder="No. of Rooms"  required  name="rooms" >
                      </div>
                      
                  </div>
                  <!-- <button type="submit" class="btn btn-outline-dark">Create Account</button> -->
                  <input type="submit" id="btn" class="button btn btn-outline-dark" value="Add Hotel">
              </form>
          </div>        
        </div>
      </div>
