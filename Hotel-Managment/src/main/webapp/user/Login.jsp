    ...
    <script >
    	window.onpageshow=function(event){
    		if(event.persisted){
    			...
    			window.location.replace('/Hotel-Managment/user/Home2.jsp');
    		}
    	};
    </script>
</head>
<body>
        ...
        <center> <h2> Please Enter Valid Credentials </h2> </center>
            ...
            <div class="row justify-content-left">
              <div class="col-md-8">
                  ...
                  <form action="../login"  method="post">
                      ...
                      <input type="submit" id="btn" class="button btn btn-outline-dark" value="Sign in" >
                  </form>
              </div>        
            </div>
        </div>
