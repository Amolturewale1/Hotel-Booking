      ...
      <div class="col-md-8">
          ...
          <form action="../payment"  method="post">
              ...
              <div class="row mb-3">
                    ...
                    <div class="col">
                        <label for="contact" class="form-label">CVV :</label>
               ...
               <div class="row mb-3">
                    ...
                    <div class="col">
                        ...
                        name="price"  readonly="readonly" value="<%= bookingDetails.getTotalPrice()%>">
                    </div>	
                    <div class="col">
                    </div>
              </div>
              ...
              <input type="submit" id="btn" class="button btn btn-outline-dark" value="Pay">
          </form>
      </div>        
    </div>
  </div>
