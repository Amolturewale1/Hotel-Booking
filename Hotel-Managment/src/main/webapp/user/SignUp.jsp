            ...
            <div class="collapse navbar-collapse" id="navbarNav">
              <ul class="navbar-nav">
                <li class="nav-item active">
                  <a class="nav-link " href="http://localhost:8080/Hotel-Managment/index.jsp">Home</a>
                </li>
                <li class="nav-item">
                  <a class="nav-link " href="http://localhost:8080/Hotel-Managment/user/SignUp.jsp">SignUp</a>
                </li>
                <li class="nav-item">
                  <a class="nav-link " href="http://localhost:8080/Hotel-Managment/user/Login.jsp">Login</a>
                </li>
              </ul>
            </div>
...
<!-- Login Page -->
        <div class="container  w-50 p-3 m-5">
            <div class="row justify-content-left">
              <div class="col-md-8">
                  <h2 class="mb-4 " >Customer Registraion Form</h2>
                  <form action="../register"  method="post">
                      ...
                      <div class="row mb-3">
                          ...
                          <div class="col">
                            ...
                            <input type="radio" class="form-check-input" required name="gender" value="Male"  > <label class="form-label">Male</label> 
                            <input type="radio" class="form-check-input" required name="gender" value="Female"  ><label class="form-label">Female</label> 
                            <input type="radio" class="form-check-input" required name="gender" value="Other"  ><label class="form-label">Other</label>
                        </div>	
                         <div class="col">
                            <label for="contact" class="form-label">Mobile Number :</label>
                            <input type="text" class="form-control"  placeholder="Mobile Number" required name="contact">
                        </div>
                      </div>
                      <div class="row mb-3">
                          <div class="col">
                      ...
                      <input type="submit" id="btn" class="button btn btn-outline-dark" value="Create Account">
                  </form>
              </div>        
            </div>
          </div>
