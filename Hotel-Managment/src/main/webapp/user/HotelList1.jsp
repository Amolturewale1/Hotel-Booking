...
<body>
	...
	<%
		...
		if(keyword != null){
		hotels = adminDao.getHotelByKeyWord(keyword);
		}
	%>
            ...
            <%for(Hotel hotel:hotels){ %>
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>
                         <a href="/Hotel-Managment/user/BookHotel.jsp?hotelId=<%= hotel.getId() %>" id="btn" class="button btn btn-outline-dark">Book</a>
